...
CXX = g++
CXXFLAGS = -Wall -O3 -I/boot/system/develop/headers/private/app -I/boot/system/develop/headers/private/tracker -I./tracker -I/boot/system/develop/headers/private/interface
